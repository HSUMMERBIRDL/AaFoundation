...
import com.hl.foundation.library.widget.ireyclerview.animation.AlphaInAnimation;
import com.hl.foundation.library.widget.ireyclerview.animation.BaseAnimation;
import com.hl.foundation.library.widget.ireyclerview.bean.PageBean;
import com.hl.foundation.library.widget.ireyclerview.universaladapter.DataIO;
...

{
    ...
    protected void setListener(final ViewGroup parent, final ViewHolderHelper viewHolder, int
            viewType) {
        ...
        viewHolder.getConvertView().setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                if (mOnItemClickListener != null) {
                    int position = getPosition(viewHolder);
                    return mOnItemClickListener.onItemLongClick(parent, v, mDatas.get(position),
                            position);
                }
                return false;
            }
